...
class Interactions(object):
    ...
    def to_sequence(self, max_sequence_length=10, min_sequence_length=None, step_size=None):
        ...
        ratings = self.ratings[sort_indices]
        ...
        for i, (uid,
                seq) in enumerate(_generate_sequences(user_ids,
                                                      ...
                                                      max_sequence_length,
                                                      step_size)):
            sequences_ratings[i][-len(seq):] = seq
        ...
        if min_sequence_length is not None:
            ...
            sequences_ratings = sequences_ratings[long_enough]



        return sequence_users, sequences, sequences_ratings, self.num_items
