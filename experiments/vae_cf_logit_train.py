...
from model.trainer import VariationalTrainer
import numpy as np
...
MODEL_NAME = "vae_cf_choice_{}_{}".format(args.dataset, args.loss)
...
trainer = VariationalTrainer(users=X_train[:, 0].reshape(-1,1), items=X_train[:, 1:].reshape(-1,1),
